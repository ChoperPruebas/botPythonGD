...
async def ejecutar_codigo(chat_id):
    ...
    try:
        ...
        driver = webdriver.Chrome("C:\\Users\\acapaizlo\\Downloads\\chromedriver.exe", chrome_options=options)
        ...
        for bloque in bloques:
            ...
            try:
                ...
                if descuento > 60:
                    print(chat_id, img_src, descripcion, precio_normal, precio_oferta, descuento, enlace)
